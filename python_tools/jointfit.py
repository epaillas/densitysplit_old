...
class Model2:
    '''
    Nadathur & Percival RSD model (no velocity dispersion)
    '''

    def __init__(self, delta_r_files, xi_r_files, xi_smu_files,
                 covmat_file, smins, smaxs, full_fit=1):
    ...
    def theory_multipoles(self, fs8, alpha_perp, alpha_para, s, mu, denbin):
